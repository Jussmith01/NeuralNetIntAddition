...
------------------------------------------*/
template <typename T>
inline void csvreader(std::string &line,std::vector<T> &data) {
    ...
    while (tmpline.find_first_of(",")!=std::string::npos) {
        ...
        data.push_back(atof(tmpline.substr(0,tpos-1).c_str()));
...
/*----------------------------------------
  ***************************************
  |  read and store a parsed CSV        |
  ***************************************
------------------------------------------*/
template <typename T>
inline void pcsvreader(std::string &line,std::vector<T> &data,int colstart,int colend,double scale,double shift) {
    std::string tmpline(line);
